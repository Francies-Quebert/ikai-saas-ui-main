...
const InventoryTopSellingProducts = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        <Row>
          <Col flex="1 1 200px">Top Selling Products</Col>
          <Col flex="0 1 30px">
          ...
          <Col flex="0 1 110px">
            <Select
              value={paramValues[1] ? parseInt(paramValues[1]) : null}
              style={{ width: 100 }}
              size={"small"}
              onChange={(vvv) => {
                setParamValues([]);
      ...
      <div
        className="bg-white max-h-44 h-44 overflow-auto style-2"
...
export default InventoryTopSellingProducts;
