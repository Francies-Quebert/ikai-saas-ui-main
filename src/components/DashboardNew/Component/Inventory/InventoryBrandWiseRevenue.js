...
const InventoryBrandWiseRevenue = (props) => {
  ...
  useEffect(() => {
    ...
    if (dataSource && dataSource.length > 0) {
      ...
      dataSource.map((ii) => {
        return tmpDataSource.push([ii.BrandDesc, parseFloat(ii.Amount)]);
      });
    }
  ...
  return (
    ...
    >
      ...
      >
        <Row>
          <Col flex="1 1 200px">Brand Wise Revenue</Col>
          <Col flex="0 1 30px">
...
export default InventoryBrandWiseRevenue;
