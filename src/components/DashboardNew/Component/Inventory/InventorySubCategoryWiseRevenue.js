...
const InventorySubCategoryWiseRevenue = (props) => {
  ...
  useEffect(() => {
    let tmpDataSource = [[`Sub Category Name`, "Amount"]];

    if (dataSource && dataSource.length > 0) {
      //   console.log("hari", dataSource);
      dataSource.map((ii) => {
        return tmpDataSource.push([ii.SubCatDesc, parseFloat(ii.Amount)]);
      });
    }
  ...
  return (
    ...
    >
      ...
      >
        <Row>
          <Col flex="1 1 200px">Sub Category Wise Revenue</Col>
          <Col flex="0 1 30px">
...
export default InventorySubCategoryWiseRevenue;
